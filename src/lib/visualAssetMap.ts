...
const homeAssets: VisualAssetEntry[] = [
  {
    ...
    expectedFileName: "celine15.jpg",
    currentFile: `${CELINE_2026}/celine15.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Céline Dusseval avec son tambour, sourire lumineux, mer turquoise",
    priority: "indispensable",
    objectPosition: "object-[center_30%]",
    replacementInstructions:
      "Photo finale Céline 2026 — portrait avec tambour, mer turquoise.",
  },
  {
    id: "home-bienvenue-detail",
    page: "home",
    section: "bienvenue",
    usage: "Détail incrusté dans la section Bienvenue (tambour rituel)",
    expectedFileName: "tambour.jpg",
    currentFile: `${CELINE_2026}/tambour.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Tambour, plumes et sauge — instruments rituels de Céline",
    priority: "important",
    replacementInstructions:
      "Photo finale 2026 — instruments rituels.",
  },
  {
    id: "home-chemin-memoires",
    page: "home",
    section: "chemins",
    usage: "Visuel du chemin Constellations Familiales · Transgénérationnel",
    expectedFileName: "tambour.jpg",
    currentFile: `${CELINE_2026}/tambour.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Tambours, plumes et sauge — instruments rituels de Céline",
    priority: "indispensable",
    replacementInstructions:
      "Photo finale 2026 — instruments rituels (tambours, plumes, sauge).",
  },
  {
    id: "home-chemin-feminin",
    page: "home",
    section: "chemins",
    usage: "Visuel du chemin Accompagnement du Féminin · Cérémonie Cacao",
    expectedFileName: "celine6.jpg",
    currentFile: `${CELINE_2026}/celine6.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Céline avec son tambour sur la plage au coucher de soleil",
    priority: "indispensable",
    replacementInstructions:
      "Photo finale 2026 — Céline tambour plage, féminin/cacao.",
  },
  {
    ...
    currentFile: `${CELINE_2026}/celine10.jpg`,
  ...
  },
  {
    ...
    currentFile: `${CELINE_2026}/Cel1.jpg`,
    sourceKind: "site-original",
    status: "waiting-client-photo",
    ratio: "4:5",
  ...
  },
  {
    ...
    currentFile: `${CELINE_2026}/soin.jpg`,
    sourceKind: "site-original",
    status: "waiting-client-photo",
    ratio: "4:5",
  ...
  },
  {
    ...
    currentFile: `${CELINE_2026}/main.jpg`,
    sourceKind: "site-original",
    status: "waiting-client-photo",
    ratio: "4:5",
  ...
  },
  {
    ...
    currentFile: `${CELINE_2026}/celine12.jpg`,
    sourceKind: "site-original",
    status: "waiting-client-photo",
    ratio: "16:9",
...
const femininAssets: VisualAssetEntry[] = [
  {
    ...
    currentFile: `${CELINE_2026}/massage.jpg`,
    sourceKind: "site-original",
    status: "waiting-instagram-auth",
    ratio: "21:9",
  ...
  // Mapping Sprint K — feminin-cacao-tasse remappé sur tambour.jpg
  // (instruments rituels Céline : tambours, plumes, sauge)
  {
    id: "feminin-cacao-tasse",
    page: "/feminin-cacao",
    section: "rituel",
    usage: "Instruments rituels (tambour, plumes, sauge)",
    expectedFileName: "tambour.jpg",
    currentFile: `${CELINE_2026}/tambour.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Tambour, plumes et sauge — instruments rituels",
    priority: "important",
    replacementInstructions: "Photo finale 2026.",
  },
  {
    id: "feminin-cercle",
    page: "/feminin-cacao",
...
const retraitesAssets: VisualAssetEntry[] = [
  {
    ...
    page: "/retraites",
    section: "hero",
    usage: "Image hero retraite immersive (silhouette face soleil)",
    expectedFileName: "Cel1.jpg",
    currentFile: `${CELINE_2026}/Cel1.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "21:9",
