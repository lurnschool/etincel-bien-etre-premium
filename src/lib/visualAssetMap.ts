...
const homeAssets: VisualAssetEntry[] = [
  ...
  },
  {
    ...
    page: "home",
    section: "bienvenue",
    usage: "Détail incrusté dans la section Bienvenue (mains de soin)",
    expectedFileName: "celine22.jpg",
    currentFile: `${CELINE_2026}/celine22.jpg`,
    sourceKind: "final",
    status: "ok",
    ratio: "4:5",
    altText: "Mains de Céline en imposition pendant un soin",
    priority: "important",
    replacementInstructions:
      "Photo finale 2026 — mains de Céline pendant un soin (NB).",
  },
  {
