...
const palettes: Record<HeroSlide["palette"], PaletteConfig> = {
  amethyst: {
    bg: "from-[#2d2540] via-[#3d3253] to-[#4a3a64]",
    halo: "from-accent-soft/35 via-rose-soft/20 to-gold-soft/15",
    tone: "dark",
    primaryOrnament: <FeminineSun size={420} strokeWidth={0.5} className="text-gold-soft/35" />,
    accentOrnament: <AnkhSymbol size={120} strokeWidth={0.7} className="text-rose-soft/45" />,
  },
  "rose-gold": {
    bg: "from-[#fbeadf] via-[#f5dfd9] to-[#fdebd0]",
    halo: "from-rose-soft/40 via-gold-soft/30 to-bg-base",
    tone: "light",
  ...
  "deep-night": {
    bg: "from-[#251f3a] via-[#2f2848] to-[#1f1a30]",
    halo: "from-gold-soft/25 via-accent-soft/35 to-transparent",
    tone: "dark",
    primaryOrnament: <MandalaOrnament size={520} strokeWidth={0.4} className="text-gold-soft/30" />,
    accentOrnament: <MoonPhases size={220} strokeWidth={0.6} className="text-rose-soft/40" />,
  },
  "rose-velvet": {
    bg: "from-[#5a4566] via-[#6e5577] to-[#4a3a55]",
    halo: "from-rose-soft/35 via-gold-soft/20 to-accent-soft/25",
    tone: "dark",
    primaryOrnament: <AnkhSymbol size={220} strokeWidth={0.7} className="text-gold-soft/45" />,
    accentOrnament: <FeminineSun size={140} strokeWidth={0.6} className="text-rose-soft/40" />,
  },
  cacao: {
    bg: "from-[#5a402e] via-[#46321f] to-[#2e2014]",
    halo: "from-gold-soft/30 via-rose-soft/20 to-transparent",
    tone: "dark",
    primaryOrnament: <CacaoCup size={320} strokeWidth={0.7} className="text-gold-soft/40" />,
    accentOrnament: <AnkhSymbol size={150} strokeWidth={0.7} className="text-rose-soft/40" />,
  },
};
